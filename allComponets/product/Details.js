...
const Details = ({data}) => {
  ...
  return (
    <div className="bg-slate-900 shadow-lg rounded-lg p-6 md:min-h-screen w-full mx-auto">
      <div className="grid md:grid-cols-2 gap-2 md:gap-8 min-h-screen md:p-20 ">
